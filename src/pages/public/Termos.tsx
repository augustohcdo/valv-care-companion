      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            "Para que você saiba exatamente com o que conta: nesta fase piloto não há backup diário de infraestrutura (point-in-time recovery) nem cópia dos dados em provedor distinto do que hospeda a aplicação. A rede de segurança é a exportação semanal descrita acima.",
