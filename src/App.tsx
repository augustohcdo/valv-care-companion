...
const AdminArquivos = lazy(() => import("./pages/app/AdminArquivos"));
        ...
        <AuthProvider>
          ...
          <Routes>
            ...
            >
              ...
              <Route path="/app/admin/arquivos" element={<ProtectedRoute requireAdmin>{withSuspense(<AdminArquivos />, "list")}</ProtectedRoute>} />
